...
export default function ProfessionalServices() {
  ...
  const load = () => api.get('/marketplace/assignments').then((r) => setRows((r.data || []).filter((a) => ['assigned', 'in_execution', 'finished'].includes(a.status))));
        ...
        <div key={a._id} className="card card-bemc p-3 mb-3">
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <div className="d-flex gap-2">
              {a.status === 'assigned' && <button className="btn btn-sm btn-outline-primary" onClick={() => startOrFinish(a, 'in_execution')}>Iniciar</button>}
